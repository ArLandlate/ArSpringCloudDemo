package org.ar.demo.springcloud.power.configuration;
...
public class BaseConstant {
	...
	@Value("${bcst.service.power.name}")
	public void setSERVICE_POWER_NAME(String SERVICE_POWER_NAME) {
		this.SERVICE_POWER_NAME = SERVICE_POWER_NAME;
	}
	...
	public static String getSERVICE_POWER_NAME() {
		return SERVICE_POWER_NAME;
	}
